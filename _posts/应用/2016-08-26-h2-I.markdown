...
<ul>
  <li><a href="#letsencrypt" data-trigger="manu">Let’s Encrypt: How It Works</a></li>
  <li><a href="#certbot" data-trigger="manu">Certbot</a></li>
  <li><a href="#hsts" data-trigger="manu">HSTS &amp; DNSSEC</a></li>
  <li><a href="#ocsp" data-trigger="manu">OCSP</a>
    <ul>
      <li><a href="#test" data-trigger="manu">验证</a></li>
    </ul>
  </li>
  <li><a href="#alpn" data-trigger="manu">ALPN</a></li>
  <li><a href="#sni" data-trigger="manu">SNI</a></li>
</ul>
